...
public class CategoryController {
 ...
 Logger log=Logger.getLogger(CategoryController.class);
	...
	public String addCategory(@ModelAttribute("category") Category category) {
		...
		if (categoryDAO.get(category.getCy_id()) == null) {
	...
	@RequestMapping(value= "category/update/{cy_id}")
	public String updateCategory(@PathVariable("cy_id") String id ) {
	...
	@RequestMapping("category/remove/{cy_id}")
	public String  deleteCategory(@PathVariable("cy_id") String id)
			throws Exception {
